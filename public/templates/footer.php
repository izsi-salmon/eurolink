<div class="footer">
    <div class="footer-flex">
        ...
        <div class="promo-box">
            <div class="promo-box-title">Check out The Tuk Tuk Club</div>
            <div class="promo-text">
                <div class="promo-blurb">Thailand – off the beaten track.</div>
                <a href="www.thetuktukclub.com" target="_blank" class="promo-link">thetuktukclub.com</a>
            </div>
        </div>
